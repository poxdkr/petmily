...
<div class="container">
	...
	<div id="content" class="site-content">
			<div id="primary" class="content-area column full">
				...
				<h1 class="entry-title">노하우 작성</h1>
				</header>
				<!-- .entry-header -->
				<div class="entry-content">
					...
					<strong>제목 : </strong>
					<input type="text" name="btitle" id="inputBtitle">
					...
					<strong>글 작성</strong>
					<textarea id="summernote" name="btext"></textarea>
					<br>
					
					<strong>댕냥이</strong>
					<select name="boardcate">
						<option value=4 selected>강아지</option>
...
$(document).ready(function() {
	...
	function insert_go() {
		...
		if (check == true) {
			...
			document.knowhowForm.action = "insertKnowhow.do";
