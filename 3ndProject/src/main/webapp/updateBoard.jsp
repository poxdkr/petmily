...
<div id="page">
	<div class="container_Box">
		...
		<div id="container_Box">
				<div id="titleSpace">
					<h1 style="color:#ffbb00">우리 펫 이야기 수정하기!</h1>
				</div>
					...
					<p style="color:darkred; font-weight:bold;"><small>이미지가 정사각형이 아니면 부분적으로 잘릴 수 있어요! 주의해주세요!</small></p>
						<div id="imageUploadTable">
									<c:if test="${board.bpict1 != null}">
										<div id="uploadBpict1"><img src="/upload/${board.bpict1 }"></div>
									</c:if>
									<c:if test="${board.bpict1 == null}">
									...
									<c:if test="${board.bpict2 != null}">
										<div id="uploadBpict2"><img src="/upload/${board.bpict2 }"></div>
									</c:if>
									<c:if test="${board.bpict2 == null}">
									...
									<c:if test="${board.bpict3 != null}">
										<div id="uploadBpict3"><img src="/upload/${board.bpict3 }"></div>
									</c:if>
									<c:if test="${board.bpict3 == null}">
	...
	<div class="container">
		<div class="site-info">
			<h1 style="font-family: 'Hi Melody';color: #ccc;font-weight:300;text-align: center;margin-bottom:0;margin-top:0;line-height:1.4;font-size: 46px;">PETMILY</h1>
		</div>
	</div>	
	</footer>
