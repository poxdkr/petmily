	...
	<div class="container">
		...
		<div id="content" class="site-content">
			<div id="primary" class="content-area column full">
				...
				<h1 class="entry-title">위드펫 작성</h1>
				</header>
				<!-- .entry-header -->
				<div class="entry-content">
					<form name="knowhowForm">
					<strong>가게명</strong>
					<input class="inputBar" type="text" name="placename" id="inputBtitle">
					<br><br>
					
					<strong>링크</strong>
					<input id="linkBar" class="inputBar" type="text" name="link">
					<br><br>
					...
					<input id="locationBar" class="inputBar" type="text" name="location">
					<br><br>
					...
					<input class="inputBar" type="text" name="address" id="address" placeholder="주소"><br>
					...
					<input class="inputBtn" type="button" value="저장" onclick="insert_go()">
...
<script>
	...
	function insert_go() {
		...
		if (check == true) {
			document.knowhowForm.action = "insertWithpet.do";
