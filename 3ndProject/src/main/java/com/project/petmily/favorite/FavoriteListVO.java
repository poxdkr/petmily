...
public class FavoriteListVO {
	...
	public String toString() {
		return "FavoriteListVO [fidx=" + fidx + ", bidx=" + bidx + ", midx=" + midx + ", boardcate=" + boardcate
				+ ", btitle=" + btitle + ", bpict1=" + bpict1 + ", allcnt=" + allcnt + ", dogcnt=" + dogcnt
				+ ", catcnt=" + catcnt + ", knowcnt=" + knowcnt + ", freecnt=" + freecnt + ", startRowNum="
				+ startRowNum + ", endRowNum=" + endRowNum + ", rowCount=" + rowCount + ", strPageNum=" + strPageNum
				+ "]";
	}
}
